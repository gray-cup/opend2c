  ...
  "inline-flex items-center gap-2 select-none justify-center whitespace-nowrap text-sm font-medium transition-[color,box-shadow] focus-visible:outline-none focus-visible:ring-[3px] aria-invalid:ring-destructive/20 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        ...
        gray: "bg-white text-neutral-950 border border-neutral-300 hover:border-neutral-400/60 cursor-pointer rounded-lg",
        whitebggray:
          "bg-neutral-50 text-neutral-950 border border-neutral-300 hover:border-neutral-400/60 cursor-pointer rounded-lg",
        redoutline:
          "border border-blue-600 hover:border-blue-700 text-white shadow-xs bg-blue-500 hover:bg-blue-600/88 active:bg-blue-600/95 cursor-pointer rounded-lg",
        lightgray:
      ...
      size: {
        ...
        large:
          "max-sm:text-sm py-4.5 max-xs:px-5 max-xs:py-3 max-sm:px-7 px-10 text-xl has-[>svg]:px-5 cursor-pointer",
        icon: "size-9",
      },
    },
    defaultVariants: {
