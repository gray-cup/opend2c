...
const documents: Document[] = [
  { id: "pan", label: "PAN Card", description: "Permanent Account Number for tax identity", status: "verified", uploadedOn: "Mar 5, 2025" },
  { id: "aadhaar", label: "Aadhaar Card", description: "Government-issued identity proof", status: "verified", uploadedOn: "Mar 5, 2025" },
  { id: "gst", label: "GST Certificate", description: "Required if your business is GST-registered", status: "pending", uploadedOn: "Apr 14, 2025" },
  { id: "incorporation", label: "Certificate of Incorporation", description: "For companies and LLPs", status: "missing" },
  { id: "authority_letter", label: "Authorisation Letter", description: "If purchasing on behalf of an organisation", status: "rejected", uploadedOn: "Apr 10, 2025", note: "Signature missing — please upload a signed copy." },
];
    ...
    <div className="px-8 py-8 max-w-3xl">
      <div className="mb-6">
        ...
        <p className="mt-0.5 text-sm text-neutral-500">
          Verify your identity to place orders and unlock higher credit limits.
        </p>
      </div>
      ...
      <div className="rounded-xl border border-neutral-200 bg-white p-5 mb-6">
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-sm font-semibold text-neutral-900">Buyer Profile</h2>
        ...
        <div className="grid grid-cols-2 gap-x-8 gap-y-3">
          {[
            ...
            { label: "Role", value: "Procurement Manager" },
            { label: "Company", value: "Mehtabrands Pvt Ltd" },
            { label: "PAN", value: "BBBBB1111B" },
            { label: "Business Address", value: "45, Linking Road, Mumbai, MH 400050" },
